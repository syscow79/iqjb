 ...
 * @author oracle
 */
@WebServlet(name = "DepartmentServletCDI", urlPatterns = {"/DepartmentServletCDI"})
public class DepartmentServletCDI extends HttpServlet {

    @Inject
    private DepartmentSessionServiceCDI departmentSessionService1;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DepartmentServletCDI</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                Logger.getLogger(DepartmentServletCDI.class.getName()).log(Level.SEVERE, null, ex);
            }
